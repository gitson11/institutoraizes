<?php
function gerarTemplateCurso($curso) {

$titulo = htmlspecialchars($curso['nome']);
$descricao = htmlspecialchars($curso['descricao'] ?? "Descrição do curso.");
$arquivo = htmlspecialchars($curso['arquivo']);
...
<head>
  <meta charset="UTF-8">
  <title>{$titulo} – Instituto Raízes</title>
